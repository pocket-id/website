...
2. Set the **Callback URL** to the value below. After creating the OAuth provider in the next section, replace it with the exact **Redirect URI** generated by FreeScout.
   ```
